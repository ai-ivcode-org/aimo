 ...
 *
 * This implementation is suitable for single instance applications. It does not
 * provide any cross-process serialization or portability.
 *
...
class EhcacheSession<T>(
    ...
    override fun putIfAbsent(key: String, value: T) {
        val v = cache.putIfAbsent(key, value)
        if (v != null) {
            throw AlreadyExistsException("Resource with key '$key' already exists.")
        }
    }
